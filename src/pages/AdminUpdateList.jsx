        ...
        <div className="mt-6 p-4 bg-secondary/50 border border-border rounded-lg">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-6">
                <div>
                    ...
                    <input type="date" name="startDate" id="startDate" onChange={handleFilterChange} value={filters.startDate} className="block w-full rounded-md border-border bg-card py-2 px-3 text-foreground focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm"/>
                </div>
                <div>
                    <label htmlFor="endDate" className="block text-sm font-medium text-muted-foreground mb-1">End Date</label>
                    <input type="date" name="endDate" id="endDate" onChange={handleFilterChange} value={filters.endDate} className="block w-full rounded-md border-border bg-card py-2 px-3 text-foreground focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm"/>
                </div>
                <div>
                ...
                <div>
                    ...
                    <select name="projectId" id="projectId" onChange={handleFilterChange} value={filters.projectId} className="block w-full rounded-md border-border bg-card py-2 pl-3 pr-10 text-foreground focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm">
                        <option value="">All</option>
